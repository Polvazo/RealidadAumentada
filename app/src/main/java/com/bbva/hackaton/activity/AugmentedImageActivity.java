...
public class AugmentedImageActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  private CardView cardViewOfertas;
  private TextView textViewOfertas;
  private Button closeOferta;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //textViewOfertas = findViewById(R.id.text_ofertas);
    //closeOferta = findViewById(R.id.close_oferta);

    /*closeOferta.setOnClickListener(v ->
            ...
            new Runnable() {
              ...
              public void run() {
                ...
                try{
                  ...
                  AugmentedImageActivity.this.startActivity(i);
  ...
  private boolean setupAugmentedImageDatabase(Config config) {
    ...
    if (useSingleImage) {
      ...
      try (InputStream is = getAssets().open("images_bd.imgdb")) {
