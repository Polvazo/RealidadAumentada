...
object AugmentedRealityLocationUtils {
    ...
    private const val RENDER_MARKER_MAX_DISTANCE = 1000//meters
    ...
    fun getScaleModifierBasedOnRealDistance(distance: Int): Float {
        return when (distance) {
            ...
            in 551..700 -> 0.35f
            in 701..850 -> 0.3f
            in 851..RENDER_MARKER_MAX_DISTANCE -> 0.25f
    ...
    fun generateRandomHeightBasedOnDistance(distance: Int): Float {
        return when (distance) {
            in 0..200 -> (1..3).random().toFloat()
            in 201..400 -> (4..6).random().toFloat()
            in 401..600 -> (7..9).random().toFloat()
            in 601..800 -> (10..12).random().toFloat()
            in 801..RENDER_MARKER_MAX_DISTANCE -> (12..13).random().toFloat()
            else -> 0f
        }
    }
